        ...
        <div className="py-3 px-10 sm:px-4 md:px-6 lg:px-6">
            <div className="container mx-auto py-[16vh]">
                <div className="grid grid-cols-1 relative lg:grid-cols-2 gap-8 items-center">
                    <div className="lg:w-[32rem] w-fullflex flex-col space-y-6">
                        <div className="text-4xl md:text-5xl font-bold text-[#2e2e2e] lg:text-6xl">
                            We are <span className="text-[#f53748]">
                                Serious
                        ...
                        <div className="lg:text-xl text-[#191919] md:text-lg text-base">
                            Lorem ipsum, dolor sit amet consectetur adipisicing elit. Eius laborum aut dignissimos dolor odit ab et, molestiae recusandae amet quae sed. Quasi cumque adipisci delectus corrupti, et hic fugiat dicta odio incidunt dolorum eaque, odit optio labore rerum aliquam ratione tempora minima molestiae assumenda distinctio, officia magni. Repudiandae dignissimos ducimus tempora laboriosam iste eos! Aut illum dolores, sequi tenetur consequuntur quia error praesentium exercitationem itaque sit ea eum perferendis, amet eveniet sapiente beatae reprehenderit temporibus dicta sed? Eos sunt, dolorum adipisci quasi perspiciatis deleniti! Officiis necessitatibus aspernatur illum doloribus eaque sit unde, cum distinctio suscipit quasi asperiores quidem numquam pariatur?
                        </div>
                        <div className="flex rounded-full py-2 px-4 justify-between items-center bg-white shadow-md">
                            <div className="flex items-center">
                                ...
                                <input type="text" name="" id="" placeholder='Search food here ...' className="text-[#191919] w-full border-none outline-none py-2 px-4" />
                            </div>
                            <div className="h-10 w-10 relative bg-[#fcd55e] rounded-full">
